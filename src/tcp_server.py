...
# TCP server that streams windspeed data from a JSON file to a client
...
with open('../data/windspeed_data.json', 'r') as f:
    ...
    with conn:
        ...
        while True:
            for entry in wind_data:
                # Prepare JSON object with unit_id and wind_speed
                out = {
